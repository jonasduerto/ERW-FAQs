<?php 
		$Custom_CSS = get_option("ERW_FAQ_Custom_CSS");
?>
<div class="wrap">
<div id="icon-options-general" class="icon32"><br /></div><h2>Settings</h2>

<form method="post" action="edit.php?post_type=faqs&page=options&Action=ERW_FAQ_UpdateOptions">
<table class="form-table">
<tr>
<th scope="row">Custom CSS</th>
<td>
	<fieldset><legend class="screen-reader-text"><span>Custom CSS</span></legend>
	<label title='Custom CSS'></label><textarea class='ERW-FAQ-textarea' name='custom_css'> <?php echo $Custom_CSS; ?></textarea><br />
